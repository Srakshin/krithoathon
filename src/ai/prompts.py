...
- All *_zh fields MUST be written in Simplified Chinese. Do not write normal English prose in any *_zh field. Keep only technical abbreviations, acronyms, and widely used proper nouns (for example "GPT-4", "CUDA", and "Rust") in their original English form; everything else must be Chinese.
...
{{
  ...
  "title_zh": "<Write a short title in Simplified Chinese, at most 15 words>",
  "whats_new_en": "<1-2 sentences in English>",
  "whats_new_zh": "<Write 1-2 sentences in Simplified Chinese>",
  "why_it_matters_en": "<1-2 sentences in English>",
  "why_it_matters_zh": "<Write 1-2 sentences in Simplified Chinese>",
  "key_details_en": "<1-2 sentences in English>",
  "key_details_zh": "<Write 1-2 sentences in Simplified Chinese>",
  "background_en": "<2-4 sentences in English, or empty string>",
  "background_zh": "<Write 2-4 sentences in Simplified Chinese, or an empty string>",
  "community_discussion_en": "<1-3 sentences in English, or empty string>",
  "community_discussion_zh": "<Write 1-3 sentences in Simplified Chinese, or an empty string>",
